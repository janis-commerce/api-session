...
module.exports = class ApiSession {
	...
	/**
	 * Get if has Access To All Warehouses associated to the session
	 *
	 * @return {boolean|undefined} The hasAccessToAllWarehouses field or undefined in case there are no hasAccessToAllWarehouses associated
	 */
	get hasAccessToAllWarehouses() {
		return this.authenticationData.hasAccessToAllWarehouses;
	}
	...
	validateWarehouse(warehouseIds) {
		return !!this.hasAccessToAllWarehouses || (!!warehouseIds && Array.isArray(this.warehousesIds) && this.warehousesIds.includes(warehouseIds));
	}
};
